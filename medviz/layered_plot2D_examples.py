...
# without mask colors
viz.layered_plot_path2D(
    image_path="dataset/1-1.nii", mask_paths=["dataset/small_bowel.nii"], slice=100
)
...
viz.layered_plot_data2D(image_data=image, masks_data=[mask_bowel], slice=100)
